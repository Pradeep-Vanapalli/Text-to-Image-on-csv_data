...
openai.api_key = "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"
...
text_gen = llm(provider="hf", model="totally-not-an-llm/EverythingLM-13b-16k", device_map = "auto")
